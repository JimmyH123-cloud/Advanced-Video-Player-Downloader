...
- After watching a video and decided to select another folder, use **RTWV** to reset since the tracked watched video will keep track of your previous playlist and press **Next** or **Play/Pause** to start the playback  
